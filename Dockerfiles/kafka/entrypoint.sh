...
DOMAIN=`hostname -d`
BROKER_ID=${HOST##*-}
ADVERTESED_LISTENERS="PLAINTEXT://$HOST.$DOMAIN:9092"

#LISTENERS=${LISTENERS:-PLAINTEXT://:9092}
ADVERTISED_LISTENERS=${ADVERTISED_LISTENERS:-PLAINTEXT://your.host.name:9092}
#LISTENER_SECURITY_PROTOCOL_MAP=${LISTENER_SECURITY_PROTOCOL:-PLAINTEXT:PLAINTEXT,SSL:SSL,SASL_PLAINTEXT:SASL_PLAINTEXT,SASL_SSL:SASL_SSL}
...
LOG_DIRS=${LOG_DIRS:-/opt/kafka/logs}
